...
/* Obtenir una llista de les oficines (ciutats, no codis) que tenen
...
/* Obtenir una llista de totes les comandes mostrant el seu número, el import i la descripció dels productes sol·licitats.*/


/* Obtenir una llista de les comandes amb imports superiors a 4000. Mostrar el nom del client que va sol·licitar la comanda,
...
/*  Obtenir una llista de les comandes amb imports superiors
...
/* Obtenir una llista de les comandes amb imports superiors a 150
...
/* Llista les comandes preses durant el mes d'octubre de l'any 2003 ,
...
/* Obtenir una llista de totes les comandes preses per representants de
oficines de la regió Est, mostrant només el número del
comanda, la descripció del producte i el nom del representant
que ho va prendre*/


/* Obtenir les comandes preses els mateixos dies en què un nou
representant va ser contractat. Mostrar número de comanda, import,
data comanda.*/


/* Obtenir una llista amb parelles de representants i oficines on
...
/* Mostra el nom, les vendes i la ciutat de l'oficina de cada
representant de lempresa.*/


/* Obtenir una llista de la descripció dels productes per als quals
existeix alguna comanda en què se sol·licita una quantitat més gran a les
existències del producte.*/


/* Llista els noms dels representants que tenen una quota
superior a la del director.*/



/* Obtenir una llista dels representants que treballen en una oficina
