...
# Por ejemplo: la habitacion adros tiene el puerto 3310, si ejecuta algun equipo
# local el script y entra a la misma habitacion, se asignara el mismo puerto. 
...
# Se hara un chat en donde se pueda enviar mensajes cifrados, y se podra enviar
